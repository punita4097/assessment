...
import Aux from '../../hoc/Aux1/Auxiliary';
...
class BurgerBuilder extends Component {
    ...
    state = {
        ...
        /*ingredients: {
            ...
            cheese: 0,
            meat: 0
        },*///remove this bcoz now we will use ings in place of it
       // totalPrice: 4,
       // purchasable: false,
        purchasing: false,
        loading:false,
    ...
    componentDidMount(){
       ...
       /* axios.get('https://react-my-burger-3a2ef.firebaseio.com/ingredients.json')
        .then(response=>{

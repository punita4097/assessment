...
namespace UnitTestAssign1
{
    ...
    public class DivideOperatorTest
    {
        ...
        {
            yield return new object[] { (Division: new object[] { 0, 25 }, Expected: 0D) };
            yield return new object[] { (Division: new object[] { 0, -25 }, Expected: 0D) };
            yield return new object[] { (Division: new object[] { 1, 1 }, Expected: 1D) };
            yield return new object[] { (Division: new object[] { 19, -2 }, Expected: -9.5D) };
            yield return new object[] { (Division: new object[] { -33, -11 }, Expected: 3D) };
